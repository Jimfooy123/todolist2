    ...
    <div className="flex items-center justify-center h-screen bg-gray-300">
      <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                {todo.editable ? (
                  ...
                  <span
                    ...
                    className="font-mono text-2xl font-semibold text-white truncate w-60"
                  >
                    {todo.title}
                  </span>
                )}
        ...
        <div className="flex space-x-4">
          <input
            className="w-full px-3 py-2 leading-tight border rounded shadow-sm appearance-none text-white-700 focus:outline-none focus:shadow-outline"
